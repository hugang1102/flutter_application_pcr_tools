...
const kAppBarDateFormat = 'yyyy年M月';
const kMonthFormat = 'M月';
const kMonthFormatWidthYear = 'yyyy年M月';
const kDateRangeFormat = 'yyyy年M月d日';
                  ...
                  itemBuilder: (context, index) {
                    if (index == 0) {
                      return Padding(
                        ...
                        child: Text(day.format(kDateRangeFormat)),
                      );
                    } else {
